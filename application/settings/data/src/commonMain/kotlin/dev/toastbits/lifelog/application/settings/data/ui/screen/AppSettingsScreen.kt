...
import dev.toastbits.lifelog.application.settings.domain.group.getResizablePaneContainerParamsProvider
...
fun AppSettingsScreen(settings: AppSettings): PreferencesTopScreen =
    PreferencesTopScreen(
        ...
        paneParams = settings.Interface.getResizablePaneContainerParamsProvider()
    )
